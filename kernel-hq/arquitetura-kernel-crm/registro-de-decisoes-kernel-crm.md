...
**Data:** 2026-07-22
**Decisão:** replicar o padrão já usado por `orbita-pulsar` e `quasar` (`tenant_id` TEXT + tabela `tenants_config` com feature flags, tudo em SQLite).
