...
3. **4 melhorias no Theo (Quasar)**, commitadas em `Kernel Workspace` (`orbita-quasar/main.py`+`database.py`) e replicadas manualmente na VPS via `scp` (sem git em `/var/www/orbita-agents/quasar`, ver [[infraestrutura-da-vps]]):
...
**Status:** aplicado e deployado (sistema-thieco: commits `7ed95ef`, `82eea61`; orbita-quasar: commits `252957d`, `3c2ffa2`, `3b3454c` em `Kernel Workspace`, + scp manual pra VPS).
