...
> **Rastreabilidade:** este PRD foi reconstruído a partir do código existente em `kernel-academia/`, não de um briefing registrado. Cada afirmação aponta para um arquivo real. Onde o código não permite concluir a intenção de negócio, está escrito explicitamente que é pergunta aberta — nada foi suposto.
