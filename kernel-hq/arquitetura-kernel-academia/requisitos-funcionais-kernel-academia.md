...
Requisitos **extraídos do código existente** em `orbita-workspace/kernel-academia/` — não há PRD original de produto neste repositório. Cada RF corresponde a comportamento verificável em uma Server Action, page ou lib. O status de cada módulo diz o que está implementado e o que está inerte.
