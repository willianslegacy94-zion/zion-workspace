...
**Decisão:** criar `orbita-workspace/Kernel-Kalel/` como fork do Quasar, exclusivo do Kernel. O Quasar original continua intacto.
...
**Data:** 2026-08-10
**Contexto:** o Kalel vivia como pasta solta dentro de `orbita-workspace`, sem git.
