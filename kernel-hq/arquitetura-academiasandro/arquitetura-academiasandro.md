...
**Repositório:** `academia-sandro/` vive como subpasta dentro do monorepo `orbita-workspace`, versionado no GitHub em `github.com/willianslegacy94-zion/zion-workspace` — **repositório público**, confirmado via `gh repo view`. Primeiro commit (`5e1361b`) feito em 2026-07-12; nenhum commit anterior existia (o projeto inteiro tinha vivido só como pasta não rastreada até então).
