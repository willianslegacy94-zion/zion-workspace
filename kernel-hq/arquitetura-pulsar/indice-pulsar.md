...
> **Descontinuado em 2026-08-10.** Nunca teve cliente ativo (ver `04-carteira-de-clientes.md`) e nunca foi deployado em produção — última atividade real em código foi 2026-06-24, mais de 6 semanas parado. Código (`orbita-pulsar/`) apagado. Esta documentação fica como registro de arquitetura, não representa mais um sistema em operação.
