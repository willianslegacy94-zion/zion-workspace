...
| v1.14 | 2026-07-30 | Rebranding — nome de exibição alterado de "Jocley Lanchonete" para "Jocley Grill" (constante `NOME_LANCHONETE`, usada em toda a UI: login, sidebar, navbar, cupom, KDS, DRE); repositório Git próprio criado (`git init`, sem remote no GitHub até este ponto) — antes vivia como pasta solta sem versionamento no `orbita-workspace` |
